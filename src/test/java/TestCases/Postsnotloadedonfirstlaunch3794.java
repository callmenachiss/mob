...
public class Postsnotloadedonfirstlaunch3794 
{
/*** Global Initialization for WebDriver ***/
	...
	{
		 log = LogManager.getLogger(Postsnotloadedonfirstlaunch3794.class);
	...
	@Test 
	public void PostsnotloadedonfirstlaunchPC3794() throws Exception
	{
		...
		/*** Scenario - Verify the page is loaded automatically without manual refresh in view post of discussion page  ***/
		sleep.waitminimum();
		...
		sleep.waitminimum();
		login.postbutton();
		log.info("Scenario - Verify the page is loaded automatically without manual refresh in view post of discussion page -- Passed");
		shot.takeScreenShot("Community sidebar");
