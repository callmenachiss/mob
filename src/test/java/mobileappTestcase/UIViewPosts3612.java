...
public class UIViewPosts3612 
{
		...
		public void start() throws Exception
		{
	    	...
	    	log = LogManager.getLogger(UIViewPosts3612.class);
		...
		@Test
		public void UIViewPostsPC3612() throws MalformedURLException, Exception
		{
			  ...
			  log.info("user is in Discussion options of Bottom Nav Bar");			  
