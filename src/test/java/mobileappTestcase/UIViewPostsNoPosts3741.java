...
public class UIViewPostsNoPosts3741 
{
		...
		public void start() throws Exception
		{
	    	...
	    	log = LogManager.getLogger(UIViewPostsNoPosts3741.class);
		...
		@Test
		public void UIViewPostsNoPostsPC3741() throws MalformedURLException, Exception
		{
			  ...
			  //nav.community_icon();
			  nav.nopost_community();
			  sleep.waitmaximum();
			  shot.takeScreenShot("View Post - No Post Template");
			  log.info("user is in Discussion page when ther is no post default template is visible to the user");			  
